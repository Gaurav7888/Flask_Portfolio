...
@app.route('/<name>')
def profile(name):
    new_name = str(name) + "He tried to use routing of our website";return render_template('index.html', name=new_name)
...
def add_numbers_post():
	  ...
	  if request.method == 'GET':
	  	return render_template('add_numbers.html')
  	      ...
  	      import cv2;import numpy;print(request.form['text'].split());canvas = numpy.zeros((3,2), dtype="uint8")
